...
const App: React.FC = () => {
  ...
  const [footerText, setFooterText] = useState(
    (SITE_CONTENT as any).footer?.text || "",
  );
  const [bookNowSettings, setBookNowSettings] =
    useState<BookNowSettings | null>(null);
  const [siteContent, setSiteContent] = useState<Record<
    string,
    Record<string, string>
  > | null>(SITE_CONTENT as any);
  ...
  const fetchSettings = async () => {
    ...
    if (USE_LOCAL_CONTENT_ONLY) {
      console.log(
        "[App] USE_LOCAL_CONTENT_ONLY is true, using local content only",
      );
    ...
    if (settings) {
      ...
      console.log(
        "[App] No footer settings received, footerText remains:",
        footerText,
      );
    }
  ...
  useEffect(() => {
    ...
    const initSlider = () => {
      ...
      if (isDesktop) {
        ...
        console.log(
          "[Studio Work] Desktop: Using native scroll + mouse drag with spring bounce for full visibility",
          window.innerWidth,
        );
      } else {
        ...
        console.log(
          "[Studio Work] Mobile/Tablet: Horizontal + Vertical scroll",
        );
      }
    };
  ...
  const moveSlider = (direction: "prev" | "next", e?: React.MouseEvent) => {
    ...
    let targetX =
      direction === "next" ? currentX - itemWidth : currentX + itemWidth;
  ...
  const handleBookNow = () => {
    ...
    // Check if appointment section is currently visible in viewport
    let isVisible = false;
    if (appointmentRef.current) {
      const rect = appointmentRef.current.getBoundingClientRect();
      isVisible = (rect.top >= -100 && rect.top <= window.innerHeight) || (rect.top < 0 && rect.bottom > 100);
    }
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full bg-[#010101] overflow-x-hidden"
    >
        ...
        {appState === AppState.READY && (
          ...
          >
            <div className="transition-wrapper">
              ...
              >
                <defs>
                  ...
                  >
                    <stop offset="0.1" stopColor="rgba(224, 169, 197, 0.9)" />
                    <stop offset="0.9" stopColor="rgba(255, 255, 255, 0.4)" />
                  </linearGradient>
                </defs>
                <path
                  ref={pathRef}
            ...
            <div className="fixed bottom-4 right-4 md:bottom-8 md:right-8 z-[200] flex flex-row gap-2 md:gap-3 items-center">
              ...
              >
                <svg
                  className="w-5 h-5 md:w-6 md:h-6 lg:w-7 lg:h-7 fill-current stroke-0"
                  viewBox="0 0 24 24"
                >
                      ...
                      <div className="w-full">
                        <DynamicMainHeading
                          text={
                            ...
                            (SITE_CONTENT as any).header?.main_heading ||
                            ""
                          }
            ...
            >
              ...
              <div
                ref={sliderRef}
                className="studio-scroll-container w-full h-auto overflow-x-auto overflow-y-hidden relative z-10 flex items-center mb-2 md:mb-12"
              >
                <div
                  ref={sliderTrackRef}
                  className="studio-scroll-track relative flex h-full items-center gap-4 sm:gap-8 md:gap-10 lg:gap-12 xl:gap-16 2xl:gap-20 pl-16 sm:pl-20 md:pl-28 lg:pl-32 xl:pl-36 2xl:pl-40 pr-8 will-change-transform scrollbar-hide ml-2 sm:ml-4 md:ml-6"
                  style={{ zIndex: 1, touchAction: "pan-x pan-y" }}
                >
                  {gallery.map((item, index) => (
                    <motion.div
                      key={item.id}
                      className="gallery-item studio-project-card group relative w-[280px] h-[350px] sm:w-[350px] sm:h-[450px] md:w-[450px] md:h-[600px] lg:w-[500px] lg:h-[650px] xl:w-[550px] xl:h-[700px] 2xl:w-[600px] 2xl:h-[750px] shrink-0 overflow-hidden transition-colors duration-700 bg-zinc-900 scroll-snap-start studio-glow-pulse"
                      data-index={index}
                    ...
                    >
                      ...
                      <div className="absolute bottom-8 left-8 right-8 z-20 pointer-events-none">
                        <h3 className="text-4xl md:text-5xl font-impact text-white uppercase tracking-tighter leading-none mb-2">
                          {item.title}
                        </h3>
              ...
              <div className="absolute left-0 top-0 h-full w-16 sm:w-24 md:w-32 lg:w-36 xl:w-40 2xl:w-44 flex flex-col items-center justify-between py-8 z-[70] bg-black -mt-[8%] -mb-[8%]">
                <div className="flex-1 flex flex-col justify-center gap-1 sm:gap-2 font-impact text-[40px] sm:text-[50px] md:text-[65px] lg:text-[75px] xl:text-[85px] 2xl:text-[95px] uppercase tracking-tighter leading-none select-none text-center">
                  ...
                  <span className="text-white relative z-[55]">U</span>
                  <span className="text-white relative z-[55]">D</span>
                  <span className="text-white relative z-[55]">I</span>
                  <span className="text-white relative z-[55]">O</span>
                  <div className="h-4 sm:h-6 md:h-8" />
                  <span className="text-[#E0A9C5] relative z-[55]">W</span>
                  <span className="text-[#E0A9C5] relative z-[55]">O</span>
                  <span className="text-[#E0A9C5] relative z-[55]">R</span>
                  <span className="text-[#E0A9C5] relative z-[55]">K</span>
                </div>
              </div>
              ...
              <div className="relative z-10 max-w-7xl w-full mx-auto px-4 sm:px-6 md:px-8 overflow-visible flex items-start min-h-[600px] sm:min-h-[800px] md:min-h-[1000px] lg:min-h-[1200px] pt-60 sm:pt-72 md:pt-80 lg:pt-[26rem] pb-80 sm:pb-96 md:pb-[400px] lg:pb-[500px]">
                ...
                >
                  <h2 className="font-impact text-[clamp(1.75rem,7.5vw,4.5rem)] md:text-[clamp(3rem,11vw,9rem)] text-white leading-[0.85] md:leading-none uppercase mb-6 md:mb-8 break-words">
                    CRAFTED{" "}
                    <span className="block text-[#E0A9C5]">IN CHAOS</span>
                  </h2>
                  <p className="text-zinc-300 font-light text-[clamp(0.75rem,1.4vw,1.2rem)] leading-relaxed max-w-[180px] sm:max-w-[300px] md:max-w-[450px]">
                    {siteContent?.about?.philosophy ||
                      ...
                      "We do not just cut hair; we engineer identities."}
                  </p>
                  <div className="mt-3 md:mt-6 pt-3 md:pt-6 border-t border-zinc-900/30 flex flex-col sm:flex-row md:flex-col gap-2 sm:gap-6 md:gap-3">
                    <div className="flex flex-col">
                      <span className="font-mono text-[8px] md:text-[9px] text-[#E0A9C5] tracking-[0.2em] uppercase mb-0 md:mb-0.5 opacity-70">
                        AVAILABLE // DAYS
                      </span>
            ...
            >
              ...
              <div
                ...
                className="max-w-7xl lg:mx-0 mx-auto px-6 sm:px-8 lg:pl-32 relative z-10"
              >
                <div className="flex flex-col mb-8 md:mb-12 gap-6 w-full relative">
                  <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between w-full gap-6">
                    <div className="flex flex-col items-start shrink-0">
                      <div className="font-mono text-[clamp(8px,1vw,10px)] text-[#E0A9C5] tracking-[0.4em] md:tracking-[0.5em] mb-2 uppercase">
                        {siteContent?.catalog?.catalog_label ||
                          "[ ARCHIVE // SERVICES ]"}
                      </div>
                      <h2 className="font-impact text-[clamp(3rem,10vw,8rem)] text-white leading-none uppercase whitespace-nowrap tracking-wider">
                    ...
                    <div className="w-full max-w-[320px] sm:max-w-[300px] lg:ml-auto relative mt-2 lg:mt-0 group lg:pb-2 xl:-mr-8 shrink-0">
                      <div className="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none lg:pb-2 z-10">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="text-white opacity-80 group-focus-within:text-[#E0A9C5] transition-colors duration-300 group-hover:opacity-100" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                      ...
                      <input
                        ...
                        placeholder="SEARCH SERVICES_"
                        className="w-full bg-white/5 backdrop-blur-[25px] saturate-[1.8] border border-white/10 hover:border-white/20 rounded-full py-3.5 pl-12 pr-10 text-white placeholder-white/40 font-mono text-[11px] md:text-[12px] tracking-[0.2em] outline-none shadow-[0_10px_40px_rgba(255,255,255,0.05)] focus:border-[#E0A9C5] focus:bg-white/10 transition-all duration-300 relative z-0"
                      />
                      {searchQuery && (
                        <button
                          onClick={() => setSearchQuery('')}
                          className="absolute inset-y-0 right-0 pr-5 flex items-center text-white/50 hover:text-[#E0A9C5] transition-colors lg:pb-2 p-2 z-10"
                        >
                  ...
                  <div className="flex flex-wrap gap-2 sm:gap-3 md:gap-4 border-b border-zinc-900 pb-2 w-full mt-2">
                    {[
                      "ALL",
                      ...
                      <React.Fragment key={cat}>
                        <button
                          ...
                          className={`font-impact text-[clamp(12px,2vw,20px)] tracking-[0.2em] uppercase py-1.5 px-1 transition-all duration-300 ${activeCatalogCategory === cat ? "text-white border-b-2 border-[#E0A9C5]" : "text-zinc-500 hover:text-white"}`}
                        >
                          {cat}
                        </button>
                        {index < array.length - 1 && (
                          <span className="text-[#E0A9C5] self-center opacity-30 select-none hidden sm:inline">
                            |
                          </span>
                        )}
                      </React.Fragment>
                  ...
                  <div className="max-w-xs">
                    <p className="font-mono text-[10px] md:text-[12px] text-zinc-500 uppercase tracking-widest leading-relaxed">
                      {siteContent?.catalog?.description ||
                        "A curated selection of aesthetic protocols designed for identity calibration."}
                    </p>
                  </div>
                </div>
                    ...
                    >
                      ...
                      <div className="relative bg-black/80 border border-[#E0A9C5]/50 rounded-lg p-4 md:p-5 flex flex-col sm:flex-row items-center gap-3 md:gap-4 justify-center">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-mono text-[10px] md:text-[11px] text-[#E0A9C5] uppercase tracking-wider">
                            NICE CHOICE!
                          </span>
                        </div>
                ...
                {services.length === 0 && (
                  <div className="flex flex-col items-center justify-center py-16 md:py-24 gap-4 opacity-40">
                    ...
                    <span className="font-mono text-[10px] text-[#E0A9C5] uppercase tracking-[0.3em]">
                      Services Loading...
                    </span>
                  </div>
                )}
                      ...
                      .filter(
                        (s) =>
                          (activeCatalogCategory === "ALL" ||
                            s.category === activeCatalogCategory) &&
                          (searchQuery === "" ||
                            s.title.toLowerCase().includes(searchQuery.toLowerCase()))
                      )
                      .reduce<Record<string, typeof services>>(
                        (acc, service) => {
                    ...
                    <div key={category} className="category-group">
                      <div className="mb-4 md:mb-6">
                        <div className="flex items-baseline gap-3 md:gap-4">
                          <h3 className="font-impact text-[clamp(2rem,6vw,4rem)] text-[#E0A9C5] uppercase leading-none tracking-wide">
                            {category}
                          </h3>
                          <div className="flex items-center gap-2 md:gap-3">
                            <div className="h-[1px] w-8 md:w-12 bg-[#E0A9C5]" />
                            <span className="font-mono text-[clamp(8px,1.5vw,12px)] text-white/60 uppercase tracking-widest">
                        ...
                        {categoryServices.map((service) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="flex flex-col items-end justify-center min-w-[50px] gap-1">
                                {service.duration && (
                                  <div className="flex items-center gap-1">
                                    ...
                                    <span
                                      className={`font-mono text-[12px] md:text-[14px] uppercase tracking-wider ${isSelected ? "text-[#E0A9C5]" : "text-white group-hover:text-[#E0A9C5]"}`}
                                    >
                                      {service.duration}
                                    </span>
                                  </div>
                              ...
                              <div
                                className={`absolute inset-0 border-2 ${isSelected ? "border-[#E0A9C5]" : "border-transparent group-hover:border-[#E0A9C5]/30"} pointer-events-none transition-colors`}
                              />
                            </motion.div>
                          );
                        })}
                  ...
                  {selectedServiceIds.length > 0 && (
                    ...
                    >
                      <div className="w-full flex flex-col items-center pt-6 border-t-4 border-white">
                        <span className="font-mono text-[7px] md:text-[8px] text-white uppercase tracking-[0.3em] md:tracking-[0.4em] mb-2 md:mb-4">
                      ...
                      >
                        <span className="relative z-10 flex items-center justify-center gap-3 md:gap-4">
                          BOOK {selectedServiceIds.length}{" "}
                          {selectedServiceIds.length === 1
                            ? "SESSION"
                            : "SESSIONS"}
            ...
            <section
              id="footer"
              ref={footerRef}
              className="relative z-20 bg-[#E0A9C5] py-16 md:py-20 flex flex-col items-center justify-center text-black overflow-visible"
            >
              <TornEdge color="#E0A9C5" position="top" />
              <div className="text-center px-6">
                <h2 className="text-[clamp(4rem,15vw,12rem)] font-impact leading-[0.85] tracking-tighter mb-4 uppercase">
                  {bookNowSettings?.reserve_heading || "RESERVE"} <br />
                  {bookNowSettings?.reserve_heading ? "" : "NOW"}
                </h2>
                <p className="max-w-xl mx-auto font-mono text-[clamp(10px,1.2vw,12px)] uppercase tracking-[0.3em] md:tracking-[0.4em] mb-8 md:mb-10 px-4">
                  {bookNowSettings?.reserve_description ||
                    "AVAILABILITY IS LIMITED. EXPERIENCE IS MANDATORY."}
                </p>
                <motion.button
                  onClick={handleBookNow}
                  whileHover={{
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="px-8 py-3 md:px-10 md:py-3 border-2 border-black font-impact text-lg md:text-xl uppercase tracking-widest transition-colors duration-300"
                >
                  {selectedServiceIds.length > 0
                    ? `Book ${selectedServiceIds.length} ${selectedServiceIds.length === 1 ? "Session" : "SESSIONS"}`
            ...
            <AnimatePresence>
              {showAppointment && !isConfirmed && (
                <motion.section
                  ...
                  animate={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
                  className="relative z-[30] bg-black text-white pt-24 md:pt-32 pb-24 md:pb-32 px-6 md:px-12 flex flex-col items-center overflow-visible"
                >
                  <div className="w-full max-w-7xl relative z-10">
                    <div className="mb-12 md:mb-16 w-full flex flex-col md:flex-row items-center md:items-baseline justify-center gap-2">
                      <span className="font-mono text-[clamp(10px,1.5vw,12px)] tracking-[0.2em] md:tracking-[0.3em] text-[#E0A9C5] font-bold uppercase whitespace-nowrap md:translate-y-[-0.2vw]">
                        // BEGIN YOUR TRANSFORMATION
                      </span>
                      <h2 className="font-impact text-[clamp(3rem,10vw,8vw)] uppercase tracking-tighter leading-none text-center md:text-left">
                        {bookNowSettings?.page_title || "BOOK"}{" "}
                        <span className="text-zinc-700">
                          {bookNowSettings?.page_title ? "" : "NOW"}
                        </span>{" "}
                        <span className="text-zinc-500 text-[0.5em] font-impact tracking-[0.1em] ml-4 uppercase transition-all duration-500">
                          {bookNowSettings?.page_subtitle || "CUSTOM"}
                        </span>
                      </h2>
                    </div>
                    ...
                    <div className="relative border-t border-zinc-800 pt-10 md:pt-12 pb-20 md:pb-24">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 md:gap-x-12 gap-y-12 md:gap-y-16">
                        <div className="group border-b border-zinc-800 pb-2 relative transition-colors focus-within:border-[#E0A9C5]">
                          ...
                          <input
                            ...
                            placeholder={
                              bookNowSettings?.subject_placeholder ||
                              "ENTER NAME_"
                            }
                            autoComplete="off"
                            className="w-full bg-transparent font-impact text-[clamp(1.25rem,2.5vw,2rem)] outline-none placeholder-zinc-800 text-white [-webkit-autofill]:bg-transparent [-webkit-autofill]:text-white [&::selection]:bg-transparent [&::selection]:text-white"
                          />
                          {errors.subjectName && (
                            <span
                              key={`subject-${vibrateKey}`}
                              className="absolute -bottom-5 left-0 font-mono text-sm text-red-500 font-bold animate-vibrate"
                            >
                              {errors.subjectName}
                            </span>
                          )}
                        ...
                        <div className="group border-b border-zinc-800 pb-2 relative transition-colors focus-within:border-[#E0A9C5]">
                          ...
                          <input
                            ...
                            placeholder={
                              bookNowSettings?.email_placeholder ||
                              "ENTER EMAIL_"
                            }
                            autoComplete="off"
                            className="w-full bg-transparent font-impact text-[clamp(1.25rem,2.5vw,2rem)] outline-none placeholder-zinc-800 text-white [-webkit-autofill]:bg-transparent [-webkit-autofill]:text-white [&::selection]:bg-transparent [&::selection]:text-white"
                        ...
                        <div className="group border-b border-zinc-800 pb-2 relative focus-within:border-[#E0A9C5] transition-colors">
                          <label className="block font-mono text-[clamp(11px,1.2vw,12px)] text-[#E0A9C5] uppercase tracking-widest mb-1">
                            {bookNowSettings?.coms_label || "Coms. Link"}
                          </label>
                          <input
                            type="tel"
                            value={comsLink}
                            ...
                            placeholder={
                              bookNowSettings?.coms_placeholder ||
                              "+1 (000) 000-0000"
                            }
                            autoComplete="off"
                            className="w-full bg-transparent font-impact text-[clamp(1.25rem,2.5vw,2rem)] outline-none placeholder-zinc-800 text-white [-webkit-autofill]:bg-transparent [-webkit-autofill]:text-white [&::selection]:bg-transparent [&::selection]:text-white"
                        ...
                        <div className="group relative">
                          <label className="block font-mono text-[11px] md:text-[12px] text-[#E0A9C5] uppercase tracking-widest mb-1">
                            {bookNowSettings?.date_label ||
                              "Temporal Coordinate"}
                          </label>
                          <div className="relative flex justify-between items-center border-b border-zinc-800 pb-1 focus-within:border-[#E0A9C5] transition-colors">
                            ...
                            <div
                              className="cursor-pointer p-1 hover:text-[#E0A9C5] transition-colors"
                              onClick={(e) => {
                                e.stopPropagation();
                                setActivePanel(
                            ...
                            <AnimatePresence>
                              {activePanel === "calendar" && (
                                <motion.div
                                  ...
                                  animate={{ opacity: 1, y: 0 }}
                                  exit={{ opacity: 0, y: 0 }}
                                  className="absolute top-full left-0 mt-0 z-[100] w-[280px] sm:w-[320px] md:w-[350px] shadow-2xl"
                                >
                                  <Suspense
                                    fallback={
                                      <div className="p-4 bg-zinc-900 border border-zinc-800 text-white font-mono text-xs">
                                        LOADING CALENDAR...
                                      </div>
                                    }
                                  >
                        ...
                        <div className="group relative transition-colors hover:border-[#E0A9C5]">
                          ...
                          <div
                            className={`relative ${errors.services ? "border-[#E0A9C5]" : "border-zinc-800"} pb-2`}
                          >
                            <div className="flex flex-col gap-2 mt-4 border-t border-zinc-800 pt-4">
                              {selectedServices.map((s) => (
                                <div
                                  key={s.id}
                                  className="flex items-center justify-between bg-zinc-900 border border-zinc-800 px-3 py-2 md:px-4 md:py-2"
                                >
                                  <span className="font-impact text-lg md:text-xl uppercase text-white leading-none">
                                    {s.title}
                                  </span>
                                  <div className="flex items-center gap-3">
                                    <span className="font-mono text-sm md:text-base text-zinc-400 uppercase min-w-[60px] text-right">
                                      {s.price}
                                    </span>
                                    <span
                                      onClick={() => toggleService(s.id)}
                                      className="w-5 h-5 flex items-center justify-center border border-zinc-700 text-zinc-500 hover:border-[#E0A9C5] hover:text-[#E0A9C5] transition-colors cursor-pointer text-[10px]"
                                    >
                                      ✕
                                    </span>
                                  </div>
                              ...
                              {selectedServices.length > 0 && (
                                <>
                                  ...
                                  <div className="flex items-center justify-between px-3 py-2">
                                    <span className="font-mono text-sm md:text-base text-white uppercase">
                                      {bookNowSettings?.estimated_label ||
                                        "ESTIMATED TOTAL INVESTMENT"}
                                    </span>
                                    <span className="font-mono text-sm md:text-base text-white uppercase">
                                      {calculateTotalPrice()}
                              ...
                              <button
                                ...
                                className="w-full flex items-center justify-center gap-1 px-2 py-2 bg-[#E0A9C5] text-white hover:bg-[#8B6B8B] transition-colors mt-2 group"
                              >
                                <svg
                                  width="14"
                                  height="14"
                            ...
                            <AnimatePresence>
                              {activePanel === "services" && (
                                <motion.div
                                  ...
                                  animate={{ opacity: 1, y: 0 }}
                                  exit={{ opacity: 0, y: 0 }}
                                  className="absolute top-full left-0 mt-4 z-[100] w-[90vw] md:w-[600px] shadow-2xl"
                                >
                                  <Suspense
                                    fallback={
                                      <div className="p-4 bg-zinc-900 border border-zinc-800 text-white font-mono text-xs">
                      ...
                      <div className="mt-16 md:mt-24 flex flex-col items-center gap-4">
                        <motion.button
                          ...
                          whileHover={{ scale: 1.05 }}
                          whileTap={{ scale: 0.95 }}
                          className="bg-[#FF5499] text-white px-10 md:px-16 py-4 md:py-6 flex items-center justify-center gap-4 md:gap-6 group w-full sm:w-auto"
                        >
                          <span className="font-impact text-2xl md:text-4xl uppercase tracking-tighter">
                            {bookNowSettings?.submit_button || "START SESSION"}
                          </span>
                        </motion.button>
              ...
              {isConfirmed && (
                <motion.section
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  className="relative z-[30] bg-black text-white px-3 md:px-12 flex flex-col items-center justify-center min-h-[70vh] md:min-h-[600px] max-w-[95%] md:max-w-[600px] mx-auto overflow-hidden"
                >
                  <div className="w-full max-w-[320px] sm:max-w-[400px] text-center mb-3 md:mb-8 flex-shrink-0">
                    <h2 className="font-impact text-xl sm:text-3xl md:text-4xl uppercase tracking-tighter mb-2 md:mb-3">
                      {bookNowSettings?.confirm_heading || "PROTOCOL INITIATED"}
                    </h2>
                    <p className="font-impact text-[10px] sm:text-xs md:text-sm text-zinc-400 uppercase tracking-wider">
                      {bookNowSettings?.confirm_description ||
                        "YOUR ARCHIVE HAS BEEN SUCCESSFULLY CREATED. DOWNLOAD YOUR PASS BELOW."}
                    </p>
                  </div>

                  <div
                    ref={ticketRef}
                    className="relative w-full max-w-[300px] sm:max-w-[400px] aspect-[3/4] sm:aspect-auto bg-black border-2 border-[#E0A9C5] p-3 sm:p-6 md:p-8 overflow-hidden shadow-[0_0_30px_rgba(224,169,197,0.3)] rounded-sm overflow-y-auto"
                  >
                    ...
                    <div className="border-b border-zinc-800 pb-3 sm:pb-4 md:pb-6 mb-3 sm:mb-4 md:mb-6 flex justify-between items-start">
                      <div className="text-left">
                        <h3 className="font-impact text-lg sm:text-xl md:text-2xl uppercase leading-none mb-0.5 sm:mb-1">
                          ESTILO BEAUTY SALON
                        </h3>
                        <span className="font-mono text-[5px] sm:text-[6px] md:text-[7px] text-zinc-500 tracking-[0.15em] md:tracking-[0.2em]"></span>
                      </div>
                      <div className="bg-[#E0A9C5] px-1.5 py-0.5 sm:px-2 sm:py-1 font-mono text-[5px] sm:text-[6px] md:text-[7px] text-black font-black uppercase">
                        {bookNowSettings?.confirmed_badge || "CONFIRMED"}
                      </div>
                    </div>

                    <div className="space-y-1 sm:space-y-2 md:space-y-3 text-left">
                      <div>
                        <label className="block font-mono text-[7px] sm:text-[8px] md:text-[9px] text-[#E0A9C5] uppercase tracking-widest mb-1">
                          {bookNowSettings?.confirm_subject_label || "Name"}
                        </label>
                        <p className="font-impact text-xs sm:text-sm md:text-base text-white">
                          {subjectName}
                        </p>
                      </div>
                      <div>
                      ...
                      <div className="grid grid-cols-2 gap-3 sm:gap-4">
                        <div>
                          <label className="block font-mono text-[7px] sm:text-[8px] md:text-[9px] text-[#E0A9C5] uppercase tracking-widest mb-1">
                            {bookNowSettings?.confirm_coordinate_label ||
                              "Coordinate"}
                          </label>
                          <p className="font-impact text-xs sm:text-sm md:text-base text-white">
                            {displayDate}
                        ...
                        <div>
                          <label className="block font-mono text-[7px] sm:text-[8px] md:text-[9px] text-[#E0A9C5] uppercase tracking-widest mb-1">
                            {bookNowSettings?.confirm_investment_label ||
                              "Investment"}
                          </label>
                          <p className="font-impact text-xs sm:text-sm md:text-base text-white">
                            ${calculateTotalPrice()}
                      ...
                      <div>
                        <label className="block font-mono text-[7px] sm:text-[8px] md:text-[9px] text-[#E0A9C5] uppercase tracking-widest mb-1">
                          {bookNowSettings?.confirm_protocol_label ||
                            "Protocol Sequence"}
                        </label>
                        <div className="space-y-0.5">
                          {selectedServices.map((s) => (
                            <p
                              key={s.id}
                              className="font-impact text-[10px] sm:text-xs md:text-sm text-white leading-none"
                            >
                              {s.title}
                            </p>
                          ))}
                      ...
                      <div className="pt-3 sm:pt-4 border-t border-zinc-900 flex justify-between items-end">
                        <div className="space-y-0.5">
                          <span className="block font-mono text-[4px] sm:text-[5px] md:text-[5px] text-zinc-600 uppercase">
                            {" "}
                            {Math.random()
                              .toString(36)
                              .substr(2, 9)
                  ...
                  <div className="mt-auto pt-4 sm:pt-6 md:pt-8 flex gap-2 sm:gap-3 md:gap-4 w-full sm:w-auto">
                    <motion.button
                      ...
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="flex-1 border border-zinc-800 px-3 py-3 sm:px-6 sm:py-3 md:px-8 md:py-4 font-impact text-xs sm:text-base md:text-lg uppercase tracking-tighter"
                    >
                      {bookNowSettings?.cancel_button || "CANCEL"}
                    </motion.button>
                    <motion.button
                      onClick={() => {
                      ...
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="flex-1 bg-white text-black px-3 py-3 sm:px-6 sm:py-3 md:px-8 md:py-4 font-impact text-xs sm:text-base md:text-lg uppercase tracking-tighter"
                    >
                      {bookNowSettings?.download_button || "DOWNLOAD"}
                    </motion.button>
                  </div>
                </motion.section>
              )}
            ...
            <section
              id="archive-details"
              className="relative z-20 bg-[#050505] py-8 md:py-32 px-4 sm:px-8 md:px-12 border-t border-zinc-900 overflow-hidden"
            >
              <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 xl:gap-20 items-start">
                  <div
                    ref={archiveProfileRef}
                    className="lg:col-span-4 text-left min-w-0"
                  >
                    <div className="font-mono text-[10px] md:text-[12px] text-[#E0A9C5] tracking-[0.4em] md:tracking-[0.5em] mb-4 md:mb-6 uppercase">
                      {" "}
                      {siteContent?.profile?.label ||
                        "[ PERSONNEL RECORD // ARCH-01 ]"}{" "}
                    </div>
                    <h3 className="font-impact text-4xl sm:text-6xl md:text-7xl text-white uppercase leading-[0.85] mb-3 md:mb-8">
                      {" "}
                      {siteContent?.profile?.name || ""} <br />{" "}
                      {siteContent?.profile?.name ? "" : ""}{" "}
                    </h3>
                    <div className="space-y-4">
                      <p className="font-mono text-[11px] md:text-[13px] text-zinc-400 uppercase leading-relaxed tracking-wider border-l border-[#E0A9C5] pl-4">
                        {siteContent?.profile?.title ||
                          "CHIEF AESTHETIC ARCHITECT. <br />15 YEARS OF IDENTITY CALIBRATION. <br />DISTRICT 41 REPRESENTATIVE."}
                      </p>
                      <p className="font-mono text-[11px] md:text-[13px] text-zinc-400 uppercase italic">
                        {siteContent?.profile?.quote ||
                          '"EVERY LINE IS A CALIBRATION, EVERY SHADE A CHOICE. WE DISCARD THE CONVENTIONAL TO ENGINEER THE EXCEPTIONAL."'}
                      </p>
                    </div>
                  </div>
                  <div
                    ref={archiveStatsRef}
                    className="lg:col-span-8 flex flex-col justify-center min-w-0 overflow-hidden lg:min-h-[400px] lg:pl-16 xl:pl-24"
                  >
                    <div className="font-mono text-[10px] md:text-[12px] text-zinc-500 tracking-[0.4em] md:tracking-[0.5em] mb-5 md:mb-8 uppercase lg:pl-6">
                      {" "}
                      {siteContent?.profile?.mission_label ||
                        "// THE MISSION ARCHITECTURE"}{" "}
                    </div>
                    <h2 className="text-white font-impact text-[clamp(1.2rem,3.5vw,4rem)] uppercase tracking-tighter leading-tight mb-7 md:mb-12 break-words lg:pl-6 lg:pl-6">
                      {siteContent?.profile?.mission_heading ||
                        "WE DON'T PROVIDE SERVICE. WE EXECUTE PROTOCOL. THE PARLOUR IS A CALIBRATION HUB FOR THE AVANT-GARDE."}
                    </h2>
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 md:gap-12 pt-5 md:pt-16 border-t border-zinc-900">
                      <div className="flex flex-col">
                        <span className="font-mono text-[10px] md:text-[12px] text-zinc-400 uppercase mb-1 md:mb-2 tracking-widest">
                          {siteContent?.profile?.established_label ||
                            "ESTABLISHED"}
                        </span>
                        <span className="font-impact text-2xl md:text-3xl text-white">
                          <CountUpText
                            value={
                              siteContent?.profile?.established_value || "2009"
                            }
                          />
                        </span>
                        <div className="w-6 md:w-8 h-[1px] bg-[#E0A9C5] mt-2" />
                      </div>
                      <div className="flex flex-col">
                        <span className="font-mono text-[10px] md:text-[12px] text-zinc-400 uppercase mb-1 md:mb-2 tracking-widest">
                          {siteContent?.profile?.staff_label || "STAFF COUNT"}
                        </span>
                        <span className="font-impact text-2xl md:text-3xl text-white">
                          <CountUpText
                            value={siteContent?.profile?.staff_value || "14"}
                          />
                        </span>
                        <div className="w-6 md:w-8 h-[1px] bg-zinc-800 mt-2" />
                      </div>
                      <div className="flex flex-col">
                        <span className="font-mono text-[10px] md:text-[12px] text-zinc-400 uppercase mb-1 md:mb-2 tracking-widest">
                          {siteContent?.profile?.success_label ||
                            "SUCCESS RATE"}
                        </span>
                        <span className="font-impact text-2xl md:text-3xl text-white">
                          <CountUpText
                            value={siteContent?.profile?.success_value || "96%"}
                          />
                        </span>
                        <div className="w-6 md:w-8 h-[1px] bg-[#E0A9C5] mt-2" />
                      </div>
                      <div className="flex flex-col">
                        <span className="font-mono text-[10px] md:text-[12px] text-zinc-400 uppercase mb-1 md:mb-2 tracking-widest">
                          {siteContent?.profile?.coordinate_label || "RATINGS"}
                        </span>
                        <span className="font-impact text-2xl md:text-3xl text-white">
                          <CountUpText
                            value={
                              siteContent?.profile?.coordinate_value || "4.9 ★"
                            }
                          />
                        </span>
                        <div className="w-6 md:w-8 h-[1px] bg-zinc-800 mt-2" />
            ...
            <footer
              ref={footerRef}
              className="premium-footer relative z-[25] bg-white w-full h-[20vh] sm:h-[30vh] md:h-[50vh] flex flex-col justify-end overflow-hidden border-t border-zinc-200 p-0 m-0"
            >
              <div className="footer-top absolute top-0 left-0 w-full z-40 p-3 sm:p-4 md:pl-6 md:pr-8 lg:p-8 xl:p-10 flex flex-row justify-between items-start text-black">
                <div className="flex flex-col gap-0.5 md:gap-1 font-sans text-[9px] sm:text-[11px] md:text-[12px] lg:text-[14px] xl:text-[15px] tracking-[0.05em] font-medium uppercase transition-all duration-300">
                  <span className="text-black/60">
                    {siteContent?.footer?.copyright_text ||
                      "© 2024 THE PARLOUR. ALL RIGHTS RESERVED."}
                  </span>
                  <a
                    href={`tel:${(siteContent?.footer?.phone_number || "+880 1234 567890").replace(/\s/g, "")}`}
                    className="opacity-80 normal-case hover:opacity-100 transition-all"
                  >
                    phone:{" "}
                    <span className="text-[#FF5499] font-semibold">
                      {siteContent?.footer?.phone_number || "+880 1234 567890"}
                    </span>
                  </a>
                  <a
                    href={`https://mail.google.com/mail/?view=cm&fs=1&to=${siteContent?.footer?.contact_email || "info@theparlour.com"}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="flex gap-2 sm:gap-3 md:gap-6 items-center sm:items-start">
                  <a
                    href={siteContent?.footer?.instagram || "#"}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="hover:scale-110 transition-transform duration-300 group relative flex items-center justify-center"
                  >
                    <svg
                      className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 fill-current text-black transition-opacity duration-300 group-hover:opacity-0"
                      viewBox="0 0 24 24"
                    >
                    ...
                    <svg
                      className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 absolute opacity-0 transition-opacity duration-300 group-hover:opacity-100"
                      viewBox="0 0 24 24"
                    >
                      <defs>
                        <linearGradient
                  ...
                  >
                    <svg
                      className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 fill-current text-black group-hover:text-[#EA4335]"
                      viewBox="0 0 24 24"
                    >
                  ...
                  <a
                    href={siteContent?.footer?.facebook || "#"}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="hover:scale-110 transition-transform duration-300 group"
                  >
                    <svg
                      className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 fill-current text-black group-hover:text-[#1877F2]"
                      viewBox="0 0 24 24"
                    >
              ...
              <div
                ref={footerTitleRef}
                className="w-full h-full flex items-end justify-center z-10 pointer-events-none"
              >
                <FooterTitle
                  text={footerText}
                  className="giant-text text-black select-none"
                />
              </div>
            </footer>
          </motion.div>
                ...
                {gallery.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4 translate-y-full group-hover:translate-y-0 transition-transform">
                      <h3 className="font-impact text-white text-lg uppercase">
                        {item.title}
                      </h3>
                      <p className="font-mono text-[#E0A9C5] text-xs uppercase">
                        {item.category || "WORK"}
                      </p>
                    </div>
                  </motion.div>
