                        ...
                        <footer ref={footerRef} className="premium-footer relative z-[25] bg-white w-full h-[20vh] sm:h-[30vh] md:h-[50vh] flex flex-col justify-end overflow-hidden border-t border-zinc-200 p-0 m-0">
                            <div className="footer-top absolute top-0 left-0 w-full z-40 p-3 sm:p-4 md:pl-6 md:pr-8 lg:p-8 xl:p-10 flex flex-row justify-between items-start text-black">
                                <div className="flex flex-col gap-0.5 md:gap-1 font-sans text-[9px] sm:text-[11px] md:text-[12px] lg:text-[14px] xl:text-[15px] tracking-[0.05em] font-medium uppercase transition-all duration-300">
                                    ...
                                    <a href={`tel:${(siteContent?.footer?.phone_number || '+880 1234 567890').replace(/\s/g, '')}`} className="opacity-80 normal-case hover:opacity-100 transition-all">phone: <span className="text-[#FF5499] font-semibold">{siteContent?.footer?.phone_number || '+880 1234 567890'}</span></a>
                                    <a href={`https://mail.google.com/mail/?view=cm&fs=1&to=${siteContent?.footer?.contact_email || 'info@theparlour.com'}`} target="_blank" rel="noopener noreferrer" className="opacity-100 font-bold border-t border-black/10 pt-1 normal-case text-black/90 tracking-tight hover:opacity-100 transition-all">contact with us: <span className="text-[#FF5499] font-black">{siteContent?.footer?.contact_email || 'info@theparlour.com'}</span></a>
                                </div>
                                <div className="flex gap-2 sm:gap-3 md:gap-6 items-center sm:items-start">
                                    <a href={siteContent?.footer?.instagram || '#'} target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform duration-300 group relative flex items-center justify-center">
                                        <svg className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 fill-current text-black transition-opacity duration-300 group-hover:opacity-0" viewBox="0 0 24 24">
                                        ...
                                        <svg className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 absolute opacity-0 transition-opacity duration-300 group-hover:opacity-100" viewBox="0 0 24 24">
                                            <defs>
                                    ...
                                    <a href={`https://mail.google.com/mail/?view=cm&fs=1&to=${siteContent?.footer?.contact_email || 'info@theparlour.com'}`} target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform duration-300 group">
                                        <svg className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 fill-current text-black group-hover:text-[#EA4335]" viewBox="0 0 24 24">
                                    ...
                                    <a href={siteContent?.footer?.facebook || '#'} target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform duration-300 group">
                                        <svg className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 fill-current text-black group-hover:text-[#1877F2]" viewBox="0 0 24 24">
