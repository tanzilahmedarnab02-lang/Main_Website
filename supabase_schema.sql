-- =====================================================
-- PARLOUR WEBSITE DATABASE SCHEMA (Updated)
-- =====================================================
...
-- Delete book_now section rows (not used in main website)
...
('header', 'main_heading', 'ESTILO BEAUTY SALON', 1),
('header', 'subtitle', 'BEAUTY FROM WITHIN', 2),
('header', 'status_label', 'IDENTITY REFINEMENT', 3),
('header', 'status_value', 'STATUS: OPERATIONAL', 4),
('header', 'logo_text', 'ESTILO BEAUTY SALON', 5),
('header', 'logo_image', 'https://oqgzypdognvjdscujofz.supabase.co/storage/v1/object/public/about%20section/post-estilobeautysalon-oct-10-2019%20(2).jpeg', 6)
...
INSERT INTO site_content (section, key_name, value_text, sort_order) VALUES
('footer', 'text', '', 1),
('footer', 'copyright_text', '', 2),
('footer', 'dev_email', '', 3),
('footer', 'contact_email', '', 4),
('footer', 'instagram', '', 5),
('footer', 'facebook', '', 6),
('footer', 'gmail', '', 7),
